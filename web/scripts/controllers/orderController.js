...
rangerApp.controller("listOrderCtrl", ["$scope", "$http", "$stateParams", "$window", "$uibModal",
    function ($scope, $http, $stateParams, $window, $uibModal) {
        ...
        switch (type) {
            ...
            case '1':
                ...
                break;
            case '2':
                $http.get("/Ranger/order/listToPay/" + buyer_id).then(
                    function (response) {
                        $scope.orderlist = response.data;
                    }, function (errResponse) {
                        alert("error");
                ...
                break;
            case '3':
                $http.get("/Ranger/order/listHasPaidDeposit/" + buyer_id).then(
                    function (response) {
                        $scope.orderlist = response.data;
                    }, function (errResponse) {
                        alert("error");
                ...
                break;
            case '4':
                $http.get("/Ranger/order/listHasPaidAll/+" + buyer_id).then(
                    function (response) {
                        $scope.orderlist = response.data;
                    }, function (errResponse) {
                        alert("error");
                ...
                break;
            case '5':
                $http.get("/Ranger/order/listHasFinished/" + buyer_id).then(
                    function (response) {
                        $scope.orderlist = response.data;
                    }, function (errResponse) {
                        alert("error");
                ...
                break;
            case '6':
                $http.get("/Ranger/order/listHasEvaluated/+" + buyer_id).then(
                    function (response) {
                        $scope.orderlist = response.data;
                    }, function (errResponse) {
                        alert("error");
                ...
                break;
            case '7':
                $http.get("/Ranger/order/listHasCanceled/" + buyer_id).then(
                    function (response) {
                        $scope.orderlist = response.data;
                    }, function (errResponse) {
                        alert("error");
        ...
        $scope.upload_confirm = function (order) {
        ...
        $scope.update_orderform_state = function (imagePath) {
            ...
            $http.post('/Ranger/api/supplierorderform/uploadconfirm', idAndWrapper)
                .success(function (data) {
                    console.log(data);
                    if (1 == data) {
